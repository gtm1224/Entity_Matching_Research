...
class shoesConfig(datasets.BuilderConfig):
    def __init__(self, features, data_url, **kwargs):
        super(shoesConfig, self).__init__(**kwargs)
        self.features = features
        self.data_url = data_url

class shoes(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
        shoesConfig(
            name="pairs",
            features={
            ...
            data_url="https://huggingface.co/datasets/matchbench/WDC-shoes/resolve/main/",
        ),
        shoesConfig(
            name="source",
            features={
            ...
            data_url="https://huggingface.co/datasets/matchbench/WDC-shoes/resolve/main/tableA.csv",
        ),
        shoesConfig(
            name="target",
            features={
            ...
            data_url="https://huggingface.co/datasets/matchbench/WDC-shoes/resolve/main/tableB.csv",
        ),
    ]
