...
class camerasConfig(datasets.BuilderConfig):
    def __init__(self, features, data_url, **kwargs):
        super(camerasConfig, self).__init__(**kwargs)
        self.features = features
        self.data_url = data_url

class cameras(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
        camerasConfig(
            name="pairs",
            features={
            ...
            data_url="https://huggingface.co/datasets/matchbench/WDC-cameras/resolve/main/",
        ),
        camerasConfig(
            name="source",
            features={
            ...
            data_url="https://huggingface.co/datasets/matchbench/WDC-cameras/resolve/main/tableA.csv",
        ),
        camerasConfig(
            name="target",
            features={
            ...
            data_url="https://huggingface.co/datasets/matchbench/WDC-cameras/resolve/main/tableB.csv",
        ),
    ]
