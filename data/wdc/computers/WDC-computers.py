...
class computersConfig(datasets.BuilderConfig):
    def __init__(self, features, data_url, **kwargs):
        super(computersConfig, self).__init__(**kwargs)
        self.features = features
        self.data_url = data_url

class computers(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
        computersConfig(
            name="pairs",
            features={
            ...
            data_url="https://huggingface.co/datasets/matchbench/WDC-computers/resolve/main/",
        ),
        computersConfig(
            name="source",
            features={
            ...
            data_url="https://huggingface.co/datasets/matchbench/WDC-computers/resolve/main/tableA.csv",
        ),
        computersConfig(
            name="target",
            features={
            ...
            data_url="https://huggingface.co/datasets/matchbench/WDC-computers/resolve/main/tableB.csv",
        ),
    ]
